...
class minimal_synthetic_community:
    '''
    Module Name:
...
This sample module contains one small method that filters contigs.
    ...
    def run_minimal_synthetic_community(self, ctx, params):
        """
        ...
        #BEGIN run_minimal_synthetic_community

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_minimal_synthetic_community function. Params=' + pformat(params))
        ...
        #END run_minimal_synthetic_community

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_minimal_synthetic_community return value ' +
